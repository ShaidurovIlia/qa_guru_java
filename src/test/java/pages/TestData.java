...
public class TestData {
    ...
    String[] dayMontYear = getRandomDate(18, 65);
    String dateOfBirth = String.format("%s %s,%s", dayMontYear[0], dayMontYear[1], dayMontYear[2]);
    ...
    public String[] getRandomDate(int minAge, int maxAge) {
        ...
        LocalDate randomLocalDate = LocalDate.now().minusYears(randomAge);
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd MMMM yyyy", Locale.ENGLISH);
        String formattedDate = randomLocalDate.format(formatter);
